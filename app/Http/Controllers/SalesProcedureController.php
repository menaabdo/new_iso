...
class SalesProcedureController extends Controller
{
    /**
    ...
    {
      $all_iso_archives=Archive::where('type',15)->get();
      return view('salesProcedure.index',compact('all_iso_archives'));
    }
    ...
    {
      return view('salesProcedure.create');
    }
    ...
    public function store(Request $request)
    {
            ...
            return redirect()->route('salesProcedureISO.index');;
    }
    ...
    public function show($id)
    {
      ...
      return view('salesProcedure.show',compact('archive'));
    }
    ...
    {
       $archive=Archive::find($id);
        return view('salesProcedure.edit',compact('archive'));
    }
