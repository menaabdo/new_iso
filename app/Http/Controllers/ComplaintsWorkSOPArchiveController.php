...
class ComplaintsWorkSOPArchiveController extends Controller
{
    /**
    ...
    {
      $all_iso_archives=Archive::where('type',8)->get();
      return view('complaintsWorkSOPArchive.index',compact('all_iso_archives'));
    }
    ...
    {
      return view('complaintsWorkSOPArchive.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('complaintsWorkSOPArchives');
    }
    ...
    public function edit($id)
    {
       $archive=Archive::find($id);
        return view('complaintsWorkSOPArchive.edit',compact('archive'));
    }
...
$image2 = $request->file('image_illustration');
  ...
  $data['image_illustration']=$image_path2;
    ...
    public function destroy($id)
    {
      $iso=Archive::find($id);
      $iso->forceDelete();
      return redirect()->route('complaintsWorkSOPArchives.index');
    }
