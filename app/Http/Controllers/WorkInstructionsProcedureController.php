...
class WorkInstructionsProcedureController extends Controller
{
    /**
    ...
    {
      $all_iso_archives=Archive::where('type',14)->get();
      return view('workInstructionsProcedure.index',compact('all_iso_archives'));
    }
    ...
    {
      return view('workInstructionsProcedure.create');
    }
    ...
    public function store(Request $request)
    {
            ...
            return redirect()->route('workInstructionsProcedureISO.index');;
    }
    ...
    public function show($id)
    {
      ...
      return view('workInstructionsProcedure.show',compact('archive'));
    }
    ...
    {
       $archive=Archive::find($id);
        return view('workInstructionsProcedure.edit',compact('archive'));
    }
