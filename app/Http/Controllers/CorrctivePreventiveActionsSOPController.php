...
use PDF;
class CorrctivePreventiveActionsSOPController extends Controller
{
    /**
    ...
    {
      $all_iso=ISO::with('definition','module')->where('type',6)->get();
      return view('corrctivePreventiveActionsSOP.index',compact('all_iso'));
    }
    ...
    {
      return view('corrctivePreventiveActionsSOP.create');
    }
...
$data['status']="confirmed";
    ...
    return redirect('corrctivePreventiveActionsSOP');
    }
    ...
    public function edit($id)
    {
       $iso=ISO::with('definition','module')->find($id);
        return view('corrctivePreventiveActionsSOP.edit',compact('iso'));
    }
...
$image2 = $request->file('image_illustration');
  ...
  $data['image_illustration']=$image_path2;
    ...
    public function destroy($id)
    {
      $iso=ISO::find($id);
      $iso->forceDelete();
      return redirect()->route('corrctivePreventiveActionsSOP.index');
    }
}