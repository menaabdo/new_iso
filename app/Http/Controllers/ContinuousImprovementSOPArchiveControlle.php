...
class ContinuousImprovementSOPArchiveControlle extends Controller
{
    /**
    ...
    {
      $all_iso_archives=Archive::where('type',10)->get();
      return view('ContinuousImprovementSOPArchive.index',compact('all_iso_archives'));
    }
    ...
    {
      return view('ContinuousImprovementSOPArchive.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('ContinuousSOPArchives');
    }
    ...
    public function edit($id)
    {
       $archive=Archive::find($id);
        return view('ContinuousImprovementSOPArchive.edit',compact('archive'));
    }
...
$image2 = $request->file('image_illustration');
  ...
  $data['image_illustration']=$image_path2;
    ...
    public function destroy($id)
    {
      $iso=Archive::find($id);
      $iso->forceDelete();
      return redirect()->route('ContinuousSOPArchives.index');
    }
