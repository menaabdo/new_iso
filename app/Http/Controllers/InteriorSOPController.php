...
use PDF;
class InteriorSOPController extends Controller
{
    /**
    ...
    {
      $all_iso=ISO::with('definition','module')->where('type',3)->get();
      return view('interiorISO.index',compact('all_iso'));
    }
    ...
    {
      return view('interiorISO.create');
    }
    ...
    public function edit($id)
    {
       $iso=ISO::with('definition','module')->find($id);
        return view('interiorISO.edit',compact('iso'));
    }
  ...
  $image2 = $request->file('image_illustration');
    ...
    public function destroy($id)
    {
      $iso=ISO::find($id);
      $iso->forceDelete();
      return redirect()->route('interiorsop.index');
    }
}