...
class SOPArchiveController extends Controller
{
    /**
    ...
    {
      $all_iso_archives=Archive::where('type',1)->get();
      return view('ISOArchive.index',compact('all_iso_archives'));
    }
    ...
    public function edit($id)
    {
       $archive=Archive::find($id);
        return view('ISOArchive.edit',compact('archive'));
    }
