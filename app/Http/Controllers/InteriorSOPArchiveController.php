...
class InteriorSOPArchiveController extends Controller
{
    /**
    ...
    {
      $all_iso_archives=Archive::where('type',3)->get();
      return view('interiorISOArchive.index',compact('all_iso_archives'));
    }
    ...
    {
      return view('interiorISOArchive.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('interiorArchives');
    }
    ...
    public function edit($id)
    {
       $archive=Archive::find($id);
        return view('interiorISOArchive.edit',compact('archive'));
    }
...
$image2 = $request->file('image_illustration');
  ...
  $data['image_illustration']=$image_path2;
    ...
    public function destroy($id)
    {
      $iso=Archive::find($id);
      $iso->forceDelete();
      return redirect()->route('interiorArchives.index');
    }
