...
class RiskSOPArchiveController extends Controller
{
    /**
    ...
    {
      $all_iso_archives=Archive::where('type',2)->get();
      return view('riskISOArchive.index',compact('all_iso_archives'));
    }
    ...
    {
      return view('riskISOArchive.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('risksopArchives');
    }
    ...
    public function edit($id)
    {
       $archive=Archive::find($id);
        return view('riskISOArchive.edit',compact('archive'));
    }
...
$image2 = $request->file('image_illustration');
  ...
  $data['image_illustration']=$image_path2;
    ...
    public function destroy($id)
    {
      $iso=Archive::find($id);
      $iso->forceDelete();
      return redirect()->route('risksopArchives.index');
    }
