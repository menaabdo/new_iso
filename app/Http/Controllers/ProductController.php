...
class ProductController extends Controller
{
  ...
  public function create()
  {
    ...
    $business_locations = BusinessLocation::forAddOrEditProductDropdown($business_id);
    ...
    return view('product.create')
      ->with(compact('price_groups','categories', 'brands', 'units', 'taxes', 'barcode_types', 'default_profit_percent', 'tax_attributes', 'barcode_default', 'business_locations', 'duplicate_product', 'sub_categories', 'rack_details', 'selling_price_group_count', 'module_form_parts', 'product_types', 'common_settings', 'warranties', 'pos_module_data'));
  }
  ...
  public function store(Request $request)
  {
    ...
    try {
      ...
      if (!empty($product_locations)) {
        if(in_array('all',$product_locations)){
          $product_locations = array_keys(BusinessLocation::forDropdown($business_id)->toArray());
        }
  ...
  /**
   * Checks if product sku2 already exists.
   *
   * @param  \Illuminate\Http\Request  $request
   * @return \Illuminate\Http\Response
   */
  public function checkProductSku2(Request $request)
  {
    $business_id = $request->session()->get('user.business_id');
    $sku = $request->input('sku');
    $product_id = $request->input('product_id');
