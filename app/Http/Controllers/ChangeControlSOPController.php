...
use PDF;
class ChangeControlSOPController extends Controller
{
  /**
  ...
  {
    $all_iso=ISO::with('definition','module')->where('type',9)->get();
    return view('changeControlSOP.index',compact('all_iso'));
  }
  ...
  {
    return view('changeControlSOP.create');
  }
...
$data['status']="confirmed";
  ...
  return redirect('changeControlSOP');
  }
  ...
  public function edit($id)
  {
     $iso=ISO::with('definition','module')->find($id);
      return view('changeControlSOP.edit',compact('iso'));
  }
...
$image2 = $request->file('image_illustration');
  ...
  public function destroy($id)
  {
    $iso=ISO::find($id);
    $iso->forceDelete();
    return redirect()->route('changeControlSOP.index');
  }
}