...
class UnderstandingOrganizationSOPArchiveController extends Controller
{
    /**
    ...
    {
      $all_iso_archives=Archive::where('type',7)->get();
      return view('understandingOrganizationSOPArchive.index',compact('all_iso_archives'));
    }
    ...
    {
      return view('understandingOrganizationSOPArchive.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('understandingArchives');
    }
    ...
    public function edit($id)
    {
       $archive=Archive::find($id);
        return view('understandingOrganizationSOPArchive.edit',compact('archive'));
    }
...
$image2 = $request->file('image_illustration');
  ...
  $data['image_illustration']=$image_path2;
    ...
    public function destroy($id)
    {
      $iso=Archive::find($id);
      $iso->forceDelete();
      return redirect()->route('understandingArchives.index');
    }
