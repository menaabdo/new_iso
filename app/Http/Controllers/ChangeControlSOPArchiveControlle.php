...
class ChangeControlSOPArchiveControlle extends Controller
{
    /**
    ...
    {
      $all_iso_archives=Archive::where('type',9)->get();
      return view('changeControlSOPArchive.index',compact('all_iso_archives'));
    }
    ...
    {
      return view('changeControlSOPArchive.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('changeControlSOPArchives');
    }
    ...
    public function edit($id)
    {
       $archive=Archive::find($id);
        return view('changeControlSOPArchive.edit',compact('archive'));
    }
...
$image2 = $request->file('image_illustration');
  ...
  $data['image_illustration']=$image_path2;
    ...
    public function destroy($id)
    {
      $iso=Archive::find($id);
      $iso->forceDelete();
      return redirect()->route('changeControlSOPArchives.index');
    }

    public function print($id)
    {
       $iso=ISO::with('definition','module')->find($id);
       return view('changeControlSOPArchive.print',compact('iso'));
