...
class MeetingAgendaSOPArchiveController extends Controller
{
    /**
    ...
    {
      $all_iso_archives=Archive::where('type',4)->get();
      return view('MeetingAgendaISOArchive.index',compact('all_iso_archives'));
    }
    ...
    {
      return view('MeetingAgendaISOArchive.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('meetingAgendaArchives');
    }
    ...
    public function edit($id)
    {
       $archive=Archive::find($id);
        return view('MeetingAgendaISOArchive.edit',compact('archive'));
    }
...
$image2 = $request->file('image_illustration');
  ...
  $data['image_illustration']=$image_path2;
    ...
    public function destroy($id)
    {
      $iso=Archive::find($id);
      $iso->forceDelete();
      return redirect()->route('meetingAgendaArchives.index');
    }
