...
class RecordActionSOPArchiveController extends Controller
{
    /**
    ...
    {
      $all_iso_archives=Archive::where('type',5)->get();
      return view('recordActionISOArchive.index',compact('all_iso_archives'));
    }
    ...
    {
      return view('recordActionISOArchive.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('recordActionArchives');
    }
    ...
    public function edit($id)
    {
       $archive=Archive::find($id);
        return view('recordActionISOArchive.edit',compact('archive'));
    }
...
$image2 = $request->file('image_illustration');
  ...
  $data['image_illustration']=$image_path2;
    ...
    public function destroy($id)
    {
      $iso=Archive::find($id);
      $iso->forceDelete();
      return redirect()->route('recordActionArchives.index');
    }
