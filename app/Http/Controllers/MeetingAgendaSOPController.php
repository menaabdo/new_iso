...
use PDF;
class MeetingAgendaSOPController extends Controller
{
    /**
    ...
    {
      $all_iso=ISO::with('definition','module')->where('type',4)->get();
      return view('MeetingAgendaISO.index',compact('all_iso'));
    }
    ...
    {
      return view('MeetingAgendaISO.create');
    }
    ...
    return redirect('meetingAgendasop');
    }
    ...
    public function edit($id)
    {
       $iso=ISO::with('definition','module')->find($id);
        return view('MeetingAgendaISO.edit',compact('iso'));
    }
  ...
  $image2 = $request->file('image_illustration');
    ...
    public function destroy($id)
    {
      $iso=ISO::find($id);
      $iso->forceDelete();
      return redirect()->route('meetingAgendasop.index');
    }
}