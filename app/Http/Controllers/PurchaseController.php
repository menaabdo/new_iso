...
class PurchaseController extends Controller
{
  ...
  public function create()
  {
    ...
    $walk_in_supplier = $this->contactUtil->getWalkInSupplier($business_id);

    return view('purchase.create')
      ->with(compact('walk_in_supplier','taxes', 'orderStatuses', 'business_locations', 'currency_details', 'default_purchase_status', 'customer_groups', 'types', 'shortcuts', 'payment_line', 'payment_types', 'accounts', 'bl_attributes'));
  }
