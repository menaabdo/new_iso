...
class CorrctivePreventiveActionsSOPArchiveController extends Controller
{
    /**
    ...
    {
      $all_iso_archives=Archive::where('type',6)->get();
      return view('corrctivePreventiveActionsSOPArchive.index',compact('all_iso_archives'));
    }
    ...
    {
      return view('corrctivePreventiveActionsSOPArchive.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('corrctiveArchives');
    }
    ...
    public function edit($id)
    {
       $archive=Archive::find($id);
        return view('corrctivePreventiveActionsSOPArchive.edit',compact('archive'));
    }
...
$image2 = $request->file('image_illustration');
  ...
  $data['image_illustration']=$image_path2;
    ...
    public function destroy($id)
    {
      $iso=Archive::find($id);
      $iso->forceDelete();
      return redirect()->route('corrctiveArchives.index');
    }
