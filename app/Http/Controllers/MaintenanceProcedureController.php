...
class MaintenanceProcedureController extends Controller
{
    /**
    ...
    public function index()
    {
      ...
      $all_iso_archives=Archive::where('type',12)->get();
      return view('maintenanceProcedure.index',compact('all_iso_archives'));
    }
    ...
    {
      return view('maintenanceProcedure.create');
    }
    ...
    public function store(Request $request)
    {
            ...
            return redirect()->route('maintenanceProcedureISO.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('maintenanceProcedure.show',compact('archive'));
    }
    ...
    {
       $archive=Archive::find($id);
        return view('maintenanceProcedure.edit',compact('archive'));
    }
