...
use PDF;
class ComplaintsWorkSOPController extends Controller
{
    /**
    ...
    {
      $all_iso=ISO::with('definition','module')->where('type',8)->get();
      return view('complaintsWorkSOP.index',compact('all_iso'));
    }
    ...
    {
      return view('complaintsWorkSOP.create');
    }
...
$data['status']="confirmed";
    ...
    return redirect('complaintsWorkSOP');
    }
    ...
    public function edit($id)
    {
       $iso=ISO::with('definition','module')->find($id);
        return view('complaintsWorkSOP.edit',compact('iso'));
    }
...
if($request->hasfile('image_illustration')) 
{
  ...
  $image2 = $request->file('image_illustration');
    ...
    public function destroy($id)
    {
      $iso=ISO::find($id);
      $iso->forceDelete();
      return redirect()->route('complaintsWorkSOP.index');
    }
}