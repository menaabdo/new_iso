...
class TrainingProcedureController extends Controller
{
    /**
    ...
    {
      $all_iso_archives=Archive::where('type',13)->get();
      return view('trainingProcedure.index',compact('all_iso_archives'));
    }
    ...
    {
      return view('trainingProcedure.create');
    }
    ...
    public function store(Request $request)
    {
            ...
            return redirect()->route('trainingProcedureISO.index');;
    }
    ...
    public function show($id)
    {
      ...
      return view('trainingProcedure.show',compact('archive'));
    }
    ...
    {
       $archive=Archive::find($id);
        return view('trainingProcedure.edit',compact('archive'));
    }
