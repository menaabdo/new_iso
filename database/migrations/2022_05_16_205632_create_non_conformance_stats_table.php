...
class CreateNonConformanceStatsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('non_conformance_stats', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('non_conformance_stats');
    }
}
