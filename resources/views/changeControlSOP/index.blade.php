    ...
    <section class="content">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <a href="{{ route('changeControlSOP.create') }}" class="btn btn-outline-primary mr-1 ">
                                                ...
                                                <tbody class="datatable-body ">
                                                    @foreach ($all_iso as $iso)
                                                        <tr class="datatable-row datatable-row-even" style="left: 0px;">
                                                            <td class="datatable-cell"><span>{{ $iso->manage_name }}</span>
                                                            </td>
                                                            <td class="datatable-cell"><span> <img
                                                                        src="{{ asset($iso->company_logo) }}" alt="Image"
                                                                        width="50px"></span></td>
                                                            ...
                                                            @if (Auth::user()->hasRole('Employee'))
                                                                <td>
                                                                    <form id="delete-form-{{ $iso->id }}"
                                                                        action="{{ route('changeControlSOP.destroy', $iso->id) }}"
                                                                        method="post">
