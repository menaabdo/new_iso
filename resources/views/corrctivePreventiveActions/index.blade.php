...
@section('content')
    ...
    font-weight: bold;">@lang('main.CAR/PAR')</h3>
                <hr>
            </div>
            <div class="row" style='margin:auto;width:90%'>

                <a href="{{ route('corrctivePreventiveActions.create') }}" class="btn col-md-12 mr-1"
                    style=" ">
                                                ...
                                                <tbody class="datatable-body ">
                                                  ...
                                                  btn-icon mr-2"
                                                          ...
                                                          <td style="font-size:15px">
                                                            <form id="delete-form-{{ $corrctivePreventiveActions->id }}"
                                                            class="d-flex justify-content-center"    action="{{ route('corrctivePreventiveActions.destroy', $corrctivePreventiveActions->id) }}" method="post">
