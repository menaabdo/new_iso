...
<div class="card-body" style='margin:auto;'>
          <h3 class='col-md-12' style='margin:auto;margin-top:85px;text-shadow: 1px 1px 1px #3ed3ea;text-align:center'>طلب إجراء تصحيحي / وقائي</h3>
          <hr>
          <div class="row" style='margin:auto;'>
           
              <a  href="{{ route('corrctivePreventiveActions.create') }}"  class="btn col-md-12 mr-1" style=";  float: right; font-size:20px ">
                    ...
                    <tbody class="datatable-body ">
                      ...
                      btn-icon mr-2"
                              ...
                              <td style="font-size:15px">
                                <form id="delete-form-{{ $corrctivePreventiveActions->id }}" class='d-flex justify-content-center'
                                    action="{{ route('corrctivePreventiveActions.destroy', $corrctivePreventiveActions->id) }}" method="post">
