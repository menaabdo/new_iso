...
@section('content')
    ...
    font-weight: bold;">@lang('main.Record inventory of the Forms used') </h3>
                <hr>
            </div>
            <div class="row" style='margin:auto;width:90%'>

                <a href="{{ route('recordModel.create') }}" class="btn col-md-12 mr-1"
                                        ...
                                        <div class="card-body">
                                            <table id="example1" class="table  table-striped shadow-lg">
                                                <thead>
                                                    ...
                                                    <th style=" text-align:center ">@lang('main.Management') </th>
