    ...
    <div class="card-body row" style='margin:auto;margin-top:80px'>
        ...
        <form action="{{ route('changeControlRequests.store') }}" class='col-md-12' style='margin:auto' method="post" enctype="multipart/form-data" id="fo1">
            ...
            <div class="form-group row ">
                <label for="" class="col-md-3 col-form-label">@lang('main.Change address'): </label>
                <div class="col-md-6">
            ...
            <table class="table ">
                <thead>
                    ...
                    <tr>
                        <th>
                            <div class="form-group row w-100 text-left">
                                <label for="" class="col-md-10 col-form-label text-left">@lang('main.Facilities/buildings') </label>
                        ...
                        <th>
                            <div class="form-group row w-100 text-left">
                                <label for="" class="col-md-10 col-form-label text-left">@lang('main.supplier/contractor') </label>
                                <div class="col-2 col-form-label">
                        ...
                        <th>
                            <div class="form-group row w-100 text-left">
                                <label for="" class="col-md-10 col-form-label text-left">@lang('main.document') </label>
                                <div class="col-2 col-form-label">
                    ...
                    <tr>
                        <th>
                            <div class="form-group row w-100 text-left">
                                <label for="" class="col-md-10 col-form-label text-left">@lang('main.Packaging')</label>
                                <div class="col-2 col-form-label">
                        ...
                        <th>
                            <div class="form-group row w-100 text-left">
                                <label for="" class="col-md-10 col-form-label text-left">@lang('main.Machine equipment')</label>
                                <div class="col-2 col-form-label">
                        ...
                        <th>
                            <div class="form-group row w-100 text-left">
                                <label for="" class="col-md-10 col-form-label text-left">@lang('main.manufacturing processes') </label>
                                <div class="col-2 col-form-label">
                    ...
                    <tr>
                        <th>
                            <div class="form-group row w-100 text-left">
                                <label for="" class="col-md-10 col-form-label text-left">@lang('main.Customize') </label>
                                <div class="col-2 col-form-label">
                        ...
                        <th>
                            <div class="form-group row w-100 text-left">
                                <label for="" class="col-md-10 col-form-label text-left">@lang('main.other') </label>
                                <div class="col-2 col-form-label">
            ...
            <table class='table'>
                <thead>
                    <tr>
                        <th class=" w-50 text-left col-md-6 ">
                            <div class="form-group row w-10 text-left">
                                <label for="" class="col-md-5 col-form-label">@lang('main.applicant') </label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placeholder="  ......" name="applicant">
                                </div>
                            </div>
                            <div class="form-group row w-10 text-left">
                                <label for="" class="col-md-5 col-form-label">@lang('main.section_manager') </label>
                                <div class="col-md-6">
                        ...
                        <th class=" w-50 text-left col-md-6 ">
                            <div class="form-group row w-10 text-left">
                                <label for="" class="col-md-4 col-form-label">@lang('main.date') </label>
                                <div class="col-8">
    ...
    <table class='table '>
        <thead>
            ...
            <tr>
                <th>
                    <div class="form-group row w-100 text-center">
                        <label for="" class="col-md-6 col-form-label text-center">@lang('main.low') </label>
                ...
                <th>
                    <div class="form-group row w-100 text-center">
                        <label for="" class="col-md-6 col-form-label text-center">@lang('main.medium') </label>
                        <div class="col-2 col-form-label mt-1">
                ...
                <th>
                    <div class="form-group row w-100 text-center">
                        <label for="" class="col-md-6 col-form-label text-center">@lang('main.high') </label>
                        <div class="col-2 col-form-label mt-1">
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th>
                    <div class="form-group row w-100 text-left">
                        <label for="" class="col-md-10 col-form-label text-left">@lang('main.yes') </label>
            ...
            <tr>
                <th>
                    <div class="form-group row w-100 text-left">
                        <label for="" class="col-md-6 col-form-label text-left">3-@lang('main.Equipment qualification') </label>
                    </div>
                </th>
                <th>
                    <div class="form-group row w-100 text-left">
            ...
            <tr>
                <th>
                    <div class="form-group row w-100 text-left">
                        <label for="" class="col-md-6 col-form-label text-left">4-@lang('mainValidate the process') </label>
                    </div>
                </th>
                <th>
                    <div class="form-group row w-100 text-left">
            ...
            <tr>
                <th>
                    <div class="form-group row w-100 text-left">
                        <label for="" class="col-md-6 col-form-label text-left">5-@lang('main.Check cleanliness') </label>
                    </div>
                </th>
                <th>
                    <div class="form-group row w-100 text-left">
            ...
            <tr>
                <th>
                    <div class="form-group row w-100 text-left">
                        <label for="" class="col-md-6 col-form-label text-left">6-@lang('main.Recheck') </label>
                    </div>
                </th>
                <th>
                    <div class="form-group row w-100 text-left">
            ...
            <tr>
                <th>
                    <div class="form-group row w-100 text-left">
                        <label for="" class="col-md-6 col-form-label text-left">7-@lang('main.Stability monitoring software') </label>
                    </div>
                </th>
                <th>
                    <div class="form-group row w-100 text-left">
    ...
    <table class="table">
        <thead>
            <tr>
                <th class=" w-50 text-left col-md-6 ">
                    <div class="form-group row w-10 text-left">
                        <label for="" class="col-md-5 col-form-label">@lang('main.Quality control manager') </label>
                        <div class="col-md-6">
                            <input type="text" class="form-control" placeholder="  ......" name="name_1">
                        </div>
                    </div>
                    <div class="form-group row w-10 text-left">
                        <label for="" class="col-md-5 col-form-label">@lang('main.factory manager') </label>
                        <div class="col-md-6">
                ...
                <th class=" w-50 text-left col-md-6 ">
                    ...
                    <div class="form-group row w-10 text-left">
                        <label for="" class="col-md-4 col-md-form-label">@lang('main.date') </label>
                        <div class="col-md-6">
