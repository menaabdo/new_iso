...
<section class="content" style='margin:auto;'>
    ...
    font-weight: bold;">
           @lang('main.Follow up on the results of the internal audit')</h3>
                <hr>
                </div>
                                            ...
                                            <table id="example1" class="table  table-striped shadow-lg">
                                                <thead>
                                                    <tr style='background-color: #001635;color:white;text-align:center'>
                                                         ...
                                                         <th>@lang('main.Department Name')</th>
      ...
      @if (Auth::user()->hasRole('Employee'))
                          ...
                          btn-icon mr-2"
                                  ...
                                  <td style="font-size:15px">
                                    <form id="delete-form-{{ $interior->id }}" class="d-flex justify-content-center"
                                        action="{{ route('interior.destroy', $interior->id) }}" method="post">
