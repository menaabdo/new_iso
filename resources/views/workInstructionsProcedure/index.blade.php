...
<section class="content" style='margin:auto;'>
    ...
    font-weight: bold;">@lang('main.workInstructionsProcedure')</h3>
            <hr>
        </div>
        <div class="row" style='margin:auto;width:90%'>

            <a href="{{ route('workInstructionsProcedureISO.create') }}" class="btn col-md-12 mr-1" style="margin-top: 40px;">
                                        ...
                                        <tbody class="datatable-body text-center">
                                            ...
                                            <tr class="datatable-row datatable-row-even" style="left: 0px;">
                                                ...
                                                <td style="font-size:15px">
                                                    <form id="delete-form-{{ $all_iso_archive->id }}" action="{{ route('workInstructionsProcedureISO.destroy', $all_iso_archive->id) }}" method="post">

                                                        <a href="{{ route('workInstructionsProcedureISO.show', $all_iso_archive->id) }}" class="btn btn-lg  
                                        btn-icon " title="@lang('main.show')">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                        @csrf
                                                        @method('delete')
                                                        <button type="button" style="border: none;" class="btn btn-lg btn-outline-danger" title="@lang('main.delete')" onclick="confirmDelete('delete-form-{{ $all_iso_archive->id }}')">
