...
<style>
    ...
    <div class="row card" style='margin:auto;margin-top:80px' >
        ...
        <form action="{{route('understandingArchives.store')}}" class='col-md-10' style='margin:auto' method="post" enctype="multipart/form-data" id="fo1">
            {{ csrf_field() }}
            <input type="hidden" name="type" value="7">
            <div style="" class="w-100 text-center my-4">
                <h2 style='text-shadow: 1px 1px 1px #3ed3ea;'>@lang('main.Archive') @lang('main.Organization Context') </h2>
                <hr class="w-100">
            </div>
            <div class='row'>
