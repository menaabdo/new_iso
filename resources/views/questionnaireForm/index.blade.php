...
<section class="content" style='margin:auto;'>
        <div class="card">
          ...
          <h3 style='margin:auto;margin-top:85px;text-shadow: 1px 1px 1px #3ed3ea;'>نموذج استبيان عن الدورة و المدرب</h3>
          <hr>
          </div>
        <div class="row" style='margin:auto;width:90%'>
     
           
              <a  href="{{ route('questionnaireForms.create') }}"  class="btn col-md-12 mr-1" style="width:120px;  float: right; font-size:20px ">
