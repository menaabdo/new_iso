...
<div class=" form-group row  text-center">
            ...
            <div class=" form-group row w-200 text-right">
                <label for="" class="col-2 col-form-label text-right">@lang('main.name'):</label>
                <div class="col-5">
                    <input type="text" class="form-control" name="name_6" value="{{$Non_conformities->name_6}}"  >
                </div>
                <label for="" class="col-3 col-form-label text-right">@lang('main.job'):</label>
                <div class="col-5">
                    <input type="text" class="form-control" name="employ_4" value="{{$Non_conformities->employ_4}}">
                </div>
                <label for="" class="col-2 col-form-label text-right">@lang('main.date')  :</label>
                <div class="col-5">
...
@elseif(($Non_conformities->status == 'inProgress' && Auth::user()->hasRole('SuperAdmin')) ||
    ...
    <button style="border-radius:8px;margin: 50px; width:30% ;background-color: #2a415b; ;height: 5%;padding:10px;margin-right:100px;margin:auto" type="submit" class="btn btn-primary col-md-4">
        <i class="fas fa-save" style="width:15% ; height: 20%;">@lang('main.edit')
            </i></button>
    </div>
@endif
    </form>
