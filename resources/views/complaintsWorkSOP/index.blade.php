...
<section class="content" style='margin:auto;'>
    ...
    font-weight: bold;">@lang('main.Measuring customer satisfaction')</h3>
                <hr>
                </div>
      <div class="row" style='margin:auto;width:90%'>
     
                    <a href="{{ route('complaintsWorkSOP.create') }}"  class="btn col-md-12 mr-1" style="width:120px;  float: right; font-size:20px ">
        ...
        @if (Auth::user()->hasRole('Employee'))
            <td>
                <form id="delete-form-{{ $iso->id }}"
                    action="{{ route('complaintsWorkSOP.destroy', $iso->id) }}" method="post">
                    <a href="{{ route('complaintsWorkSOP.edit', $iso->id) }}"
