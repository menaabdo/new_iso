...
<div class="container mt-3 p-3" style='background-color:white'>
   ...
   <br>
    ...
    <form action="{{route('corrctivePreventiveActionsSOP.store')}}" method="post" enctype="multipart/form-data" id="fo1">
        {{ csrf_field() }}
...
<br><br>
    ...
    font-weight: bolder;'>
        ...
        <section class="row " style="">
            <div class="input-group my-3  mx-3">
                <label class="row" style='text-shadow: 1px 1px 1px #3ed3ea;margin:auto'> @lang('main.External and internal reference sources:')</label>
            </div>
            <textarea class='shadow-lg' style='margin:auto' name="reference_sources" id="" cols="55" rows="5" style='border:none;padding:10px'
