...
td{
   ...
   text-shadow: 1px 1px 1px #3ed3ea;font-weight: bold;">@lang('main.internal audit1')</h3>
   <hr style='background-color:#3ed3ea'>
  
  
        <form action="{{ route('interiorsop.update', $iso->id) }}" method="post" enctype="multipart/form-data" id="fo1">
            @method('PUT')
            {{ csrf_field() }}
            ...
            <section style="width: 350px;margin-top: 200px;ق" class=" my-4  p-4 m-auto">
            ...
            <section style="width: 350px;margin-top: 200px;" class=" my-4  p-4 m-auto">
                <div class="form-group row ">
