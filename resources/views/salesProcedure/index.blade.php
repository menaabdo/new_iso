...
<section class="content" style='margin:auto;'>
    ...
    font-weight: bold;">@lang('main.salesProcedure')</h3>
            <hr>
        </div>
        <div class="row" style='margin:auto;width:90%'>

            <a href="{{ route('salesProcedureISO.create') }}" class="btn col-md-12 mr-1" style="margin-top: 40px;">
                                        ...
                                        <tbody class="datatable-body text-center">
                                            ...
                                            <tr class="datatable-row datatable-row-even" style="left: 0px;">
                                                ...
                                                <td style="font-size:15px">
                                                    <form id="delete-form-{{ $all_iso_archive->id }}" action="{{ route('salesProcedureISO.destroy', $all_iso_archive->id) }}" method="post">

                                                        <a href="{{ route('salesProcedureISO.show', $all_iso_archive->id) }}" class="btn btn-lg  
