...
<section class="content" style='margin:auto;'>
    ...
    font-weight: bold;">@lang('main.Archive') @lang('main.Corrective and preventive actions and cases of non-conformity')  </h3>
            <hr>
        </div>
        <div class="row" style='margin:auto;width:90%'>

            <a href="{{ route('corrctiveArchives.create') }}" class="btn col-md-12 mr-1" style="margin-top: 40px;">
                                    ...
                                    <table id="example1" class="table  table-striped shadow-lg" style=''>
                                        <thead>
                                            <tr style='background-color: #001635;color:white;text-align:center'>
                                                ...
                                                <th data-field="Actions" class="datatable-cell "><span style="">@lang('main.Action')</span></th>
                                            </tr>
                                        </thead>
                                        <tbody class="datatable-body text-center">
                                            ...
                                            <tr class="datatable-row datatable-row-even" style="left: 0px;">
                                                ...
                                                <td style="font-size:15px">
                                                    <form id="delete-form-{{ $all_iso_archive->id }}" action="{{ route('corrctiveArchives.destroy', $all_iso_archive->id) }}" method="post">

                                                        <a href="{{ route('corrctiveArchives.edit', $all_iso_archive->id) }}" class="btn btn-lg  
