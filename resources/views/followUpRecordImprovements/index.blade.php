...
@section('content')
    ...
    font-weight: bold;">@lang('main.Follow-up record of improvement and development work')</h3>
                <hr>
            </div>
            <div class="row" style='margin:auto;width:90%'>

                <a href="{{ route('followUpRecordImprovements.create') }}" class="btn col-md-12 mr-1"
                    style=" ">
                                                ...
                                                <tbody class="datatable-body ">
                                                    ...
                                                    <tr class="datatable-row datatable-row-even">
                                                      ...
                                                      <td>
                                                          ...
                                                          class="d-flex justify-content-center"   action="{{ route('followUpRecordImprovements.destroy', $followUpRecordImprovements->id) }}" method="post">
