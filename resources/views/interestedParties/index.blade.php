...
@section('content')
    ...
    font-weight: bold;">@lang('main.Interested Parties Form')</h3>
                <hr>
            </div>
    ...
    background-color:#001635;'
                ...
                <div class="col-12">
                                                                ...
                                                                <td>
                                                                    <form id="delete-form-{{ $interestedParties->id }}"
                                                                        ...
                                                                        <a href="{{ route('interestedParties.edit', $interestedParties->id) }}"
                                                                          ...
                                                                          <a href="{{ route('interestedParties.print', $interestedParties->id) }}"
                                                                        ...
                                                                        @csrf
                                                                        @method('delete')
                                                                        @if ($interestedParties->status == 'pending' && Auth::user()->hasRole('Employee'))
                                                                            <button type="button"
                                                                                class="btn btn-sm btn-clean btn-icon"
                                                                                title="@lang('general.delete')"
                                                                                onclick="confirmDelete('delete-form-{{ $interestedParties->id }}')">
                    ...
                    btn-icon mr-2"
                                                                        ...
                                                                        @csrf
                                                                        @method('delete')
                                                                        @if (($interestedParties->status == 'inProgress' && Auth::user()->hasRole('Admin')) ||
                                                                            ($interestedParties->status == 'pending' && Auth::user()->hasRole('Admin')))
                                                                            <button type="button"
                                                                                class="btn btn-sm btn-clean btn-icon"
                                                                                title="@lang('general.delete')"
                                                                                onclick="confirmDelete('delete-form-{{ $interestedParties->id }}')">
                                                            ...
                                                            @elseif(($interestedParties->status == 'inProgress' && Auth::user()->hasRole('SuperAdmin')) ||
                                                                ($interestedParties->status == 'pending' && Auth::user()->hasRole('SuperAdmin')) ||
                ...
                btn-icon "
                                                                        ...
                                                                        {{-- <a href="{{ route('interestedParties.print', $interestedParties->id) }}"
                                         data-id="{{ $interestedParties->id }}"
                                        class="btn btn-lg btn-icon">
                                        <i class="fa fa-print"></i>
                                    </a> --}}

                                                                        {{-- <a href="#" data-id="{{ $interestedParties->id }}"
