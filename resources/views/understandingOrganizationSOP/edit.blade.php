...
td{
   ...
   text-shadow: 1px 1px 1px #3ed3ea;font-weight: bold;">@lang('main.Organization Context')</h3>
   <hr style='background-color:#3ed3ea'>
  
  
        <form action="{{ route('understandingOrganizationSOP.update', $iso->id) }}" method="post" enctype="multipart/form-data" id="fo1">
            @method('PUT')
            {{ csrf_field() }}
