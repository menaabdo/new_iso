    ...
    @method('PUT') 
        ...
        <div class="container-fluid p-2">
            ...
            <div class="form-group row w-100 text-right mt-4">
                    ...
                    <div class="form-group row w-100 text-right">
                        <label for="" class="col-md-4 col-form-label"  style='margin:auto'>@lang('main.type Review'):</label>
                        <div class=" col-form-label pl-2 col-4 d-flex justify-content-center" style='margin:auto;'>
                      
                        <label for="" style=";" class="col-md-4 col-form-label">@lang('main.planing') </label>
                        ...
                        <label for="" style=";" class="col-md-3 col-form-label">@lang('main.not_planing') </label>
                          @php
                        if (App::getLocale() == 'ar')
                            $align='left';
                        else
