    ...
    <form action="{{route('InternalAuditReport.store')}}" method="post" enctype="multipart/form-data" id="fo1" class='col-md-10' style='margin:auto'>
        ...
        <div class="container-fluid p-4">
            ...
            <div class="form-group " style='text-align: center'>
                <label for="" class="col-md-4 col-form-label text-center"> @lang('main.Manage') :</label>
            ...
            <div class="container-fluid p-2">
                <section class="my-10 ">
                    ...
                    <div class=" col-form-label pl-2 col-md-8 d-flex justify-content-center" style='margin:auto;'>
                      
                        <label for="" class="col-5 col-form-label style='margin:auto'">@lang('main.type Review') :</label>
                        ...
                        <label for="" style="text-align:{{$align}};" class="col-md-4 col-form-label">@lang('main.planing') </label>
                        <div class=" col-form-label pl-2">
                            <input type="radio" style='margin-top:6px' id="planing" name="planing" value="planing" class='shadow-lg'>
                        </div>

                        <div class=" col-form-label pl-2 col-6 d-flex justify-content-center" style='margin:auto;'>
                      
                        <label for="" style="text-align:{{$align}};" class="col-md-4 col-form-label">@lang('main.not_planing') </label>
                ...
                <div class="form-group row w-100 text-right">
                    <label for="inputPassword" class="col-md-5 col-form-label">@lang('main.no_strong_point')</label>
                    <div class="col-md-10">
                ...
                <div class="form-group row w-100 ">
                    <label for="inputPassword" class="col-md-5 col-form-label">@lang('main.improvement_notes') : </label>
                    <div class="col-md-10">
