...
<div class="card">
<div class="card-body">
    <form action="{{route('nonConformanceReport.update',$nonConformanceReport->id)}}"  class='col-md-9 ' style='margin:auto;margin-top:80px' method="post" enctype="multipart/form-data" id="fo1">
        @method('PUT')
        {{ csrf_field() }}
        <div style="" class="w-100 text-center my-4">
            ...
            <input style="text-align: center;" type="text" class='form-control'  name="year" value="{{$nonConformanceReport->year}}">
            <hr class="w-100">
