...
@section('content')
    ...
    font-weight: bold;">@lang('main.Record follow-up reports of non-conformance')</h3>
                <hr>
            </div>
            <div class="row" style='margin:auto;width:90%'>

                <a href="{{ route('nonConformanceReport.create') }}" class="btn col-md-12 mr-1"
                    style=" ">
                                                ...
                                                <tbody class="datatable-body ">
                                                  ...
                                                  btn-icon mr-2"
                                                          ...
                                                          <td style="font-size:15px">
                                                            <form id="delete-form-{{ $nonConformanceReport->id }}"
                                                            class="d-flex justify-content-center"  action="{{ route('nonConformanceReport.destroy', $nonConformanceReport->id) }}" method="post">
