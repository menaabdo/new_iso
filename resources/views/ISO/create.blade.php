...
<div class="container mt-3 p-3" style='background-color:white'>
   ...
   <h4 style="text-align:center;margin-bottom:40px;color:#2a415b">خطوات العمل القياسية </h4>
    ...
    <form action="{{route('sop.store')}}" method="post" enctype="multipart/form-data" id="fo1">
        {{ csrf_field() }}
        <input type="hidden" name="type" value="1">
        <div class='row' style='flex-wrap:nowrap'>
        <div class="form__div" >
           
                            <input type="text" name="manage_name" class="form__input shadow-lg" placeholder=" اسم الاداره">
                            <label for="" class="form__label border-0 text-white">اسم الاداره</label>
                           

</div>
                        
                        <div class="form__div mb-0 " >
                            <input onfocus="(this.type='date')" name="active_date" placeholder="تاريخ التفعيل"  class="form__input text-white shadow-lg" >
                            <label for="" class="form__label text-white" >تاريخ التفعيل</label>
                        </div>
                        <div class="form__div mb-0 " >
                            <input type="number" name='page_number' class="form__input text-white shadow-lg" placeholder="عدد الصفحات">
                            <label for="" class="form__label text-white">عدد الصفحات</label>
                        </div>
</div>
<!-- dates -->
<div class='row' style='flex-wrap:nowrap'>
                        ...
                        <div class="form__div  " >
                            <input onfocus="(this.type='date')" placeholder="تاريخ الاصدار" class="form__input text-white shadow-lg" type="text" name="release_date">
                            <label for="" class="form__label text-white" >تاريخ الاصدار</label>
                        </div>
                        <div class="form__div  " >
                            <input onfocus="(this.type='date')" placeholder="تاريخ المراجعة" class="form__input text-white shadow-lg" >
                            <label id='2' for="" class="form__label text-white" >تاريخ المراجعة</label>
                        </div>
...
<div class="form__div " >
           ...
           <input type="email" class="form__input shadow-lg" placeholder="  رقم الوثيقة">
           <label for="" class="form__label border-0 text-white">رقم الوثيقة</label>
          

</div>
        <div class="form__div " >
           
                            <input type="email" class="form__input shadow-lg" placeholder=" كود الوثيقة">
                            <label for="" class="form__label border-0 text-white">كود الوثيثة</label>
...
<div class="form__div " >
           ...
           <input type="email" class="form__input shadow-lg" placeholder=" اسم الشركة">
           <label for="" class="form__label border-0 text-white">اسم الشركة</label>
          

</div>
        <div class="form__div " >
           
                            <input type="email" class="form__input shadow-lg" placeholder=" اسم الاجراء">
                            <label for="" class="form__label border-0 text-white">اسم الاجراء</label>
...
<div class="form__div " >
           ...
           <input type="email" class="form__input shadow-lg" placeholder=" رقم النسخة">
           <label for="" class="form__label border-0 text-white">رقم النسخة</label>
          

</div>
        <div class="form__div " >
           
                            <input type="email" class="form__input shadow-lg" placeholder=" حائز النسخة">
                            <label for="" class="form__label border-0 text-white">حائز النسخة</label>
...
<div class="form__div " >
           ...
           <input type="email" class="form__input shadow-lg" placeholder=" اعداد">
           <label for="" class="form__label border-0 text-white">اعداد</label>
          

</div>
        <div class="form__div " >
           
                            <input type="email" class="form__input shadow-lg" placeholder=" مراجعة">
                            <label for="" class="form__label border-0 text-white">مراجعة</label>
                           

</div>
<div class="form__div " >
           
           <input type="email" class="form__input shadow-lg" placeholder=" اعتماد">
           <label for="" class="form__label border-0 text-white">اعتماد</label>
          

</div>
</div>
<hr style='color:#3ed3ea'>

<!-- end document codes -->
        <!-- <table style="width: 850px;" class="table table-bordered my-4   m-auto">
            <thead>
                <tr>
                    <th class="text-center col-md-4" style="width: 33.333%">
                    ...
                    <th class="col-md-4" style="width: 33.333%">
        ...
        <hr style="border: 5px; margin: 30px ;">

        <!-- <section style="width: 1293px;margin-top: 200px;" class=" my-4  p-4 m-auto row">
        ...
        <section>
            <div class="row" style="text-align: start;">
                <p style='background-color:#2a415b;padding:20px;border-radius:4px;color:white'>نموذج تسلسل الاجراء هو عرض بياني لخريطة عمليات البيانات مجموعة الاجراءات الخاصة بكل ادراة من الاقسام
                    والعمليات المرتبطة بها لكل مجموعة اجراءات اهداف وسياسات خاصة بها كما انها مزودة بكيفية سير العمل
                    وباجراءات مفصلة لذلك.
                </p>
               <hr style='width:100%;margin:5px;padding:10px'>
                       <h4 style='color: #2a415b;
                        text-shadow: 1px 1px 1px #3ed3ea;
                          font-weight: bold;'>
                          المصطلحات والرسوم التوضيحيه
                        </h4>
    ...
    font-weight: bolder;'>
        ...
        <section class="row" style="">
            <div class="input-group my-3  mx-3 ">
                <label class="row" style='text-shadow: 1px 1px 1px #3ed3ea;'> الغرض من الاجراء :</label>
            </div>
        ...
        <section class="row" style="">
            <div class="input-group my-3  mx-3">
                <label class="row" style='text-shadow: 1px 1px 1px #3ed3ea;'> المقدمه :</label>
            </div>
        ...
        <section class="row" style="">
            <div class="input-group my-3  mx-3">
                <label class="row" style='text-shadow: 1px 1px 1px #3ed3ea;'> نطاق التطبيق :</label>
            </div>
        ...
        <section class="row" style="">
            <div class="input-group my-3  mx-3">
                <label class="row" style='text-shadow: 1px 1px 1px #3ed3ea;'> المصطلحات والتعريفات :</label>
            </div>
    ...
    font-weight: bolder;'>
                        ...
                        <td class="datatable-cell  ">
                            <div class="a-col alternate">
                                <div class="input-field shadow-lg">
                                    <input type="text" class="form-control" name="names[0][term]"  placeholder='ادخل المصطلح'/>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="datatable-cell  ">
                            <div class="a-col alternate">
                                <div class="input-field">
                                    <input type="text" class="form-control shadow-lg" name="names[0][definition]" placeholder='ادخل التعريف'/>
                                </div>
                            </div>
                        </td>
        ...
        <section class="row" style="">
            <div class="input-group my-3  mx-3">
                <label class="row " style='text-shadow: 1px 1px 1px #3ed3ea;'> المسؤليات :</label>
            </div>
        ...
        <section class="row" style="">
            <div class="input-group my-3  mx-3">
                <label class="row" style='text-shadow: 1px 1px 1px #3ed3ea;'> خطوات العمل :</label>
            </div>
        ...
        <section class="row" style="">
            <div class="input-group my-3  mx-3">
                <label class="row"  style='text-shadow: 1px 1px 1px #3ed3ea;'> النماذج المستخدمه :</label>
            </div>
    ...
    font-weight: bolder;'>
        ...
        <section class="row" style="">
            <div class="input-group my-3  mx-3">
                <label class="row" style='text-shadow: 1px 1px 1px #3ed3ea;'> المصادر المرجعيه الخارجيه والداخليه :</label>
            </div>
