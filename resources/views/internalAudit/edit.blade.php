...
@section('content')
    ...
    <div class="container mt-3 p-3">
        ...
        <hr>
        <form action="{{ route('internalAudit.update', $internalAudit->id) }}" method="post" enctype="multipart/form-data"
            id="fo1">
            @method('PUT')
            {{ csrf_field() }}
            <div class="form-group row w-100 text-right">
                ...
                <div class="col-4">
                    <input type="date" name="date1" class="form-control" placeholder="  ......"
                        value="{{ $internalAudit->date1 }}">
                </div>
                <label for="" class="col-2 col-form-label"> الجهة المراجع عليها :</label>
                <div class="col-4">
                    <input type="text" class="form-control" name="referenced_authority"
                        placeholder="الجهة المراجع عليها  ......" id=""
                        value="{{ $internalAudit->referenced_authority }}">
                </div>
            </div>
            <div class="form-group row w-100 text-right">
                ...
                <div class="col-4">
                    <input type="text" class="form-control" name="reference_documents"
                        value="{{ $internalAudit->reference_documents }}"placeholder="الوثائق المرجعية:   ......"
                        id="">
                </div>
            </div>
            <section class="my-5 table-bordered">
                    ...
                    <thead>
                        <tr style="background-color:lightgreen">
                            @if ($internalAudit->status == 'pending' && Auth::user()->hasRole('Employee'))
                                <th scope="col" rowspan="2" data-field=""
                                ...
                                <tr class="datatable-row datatable-row-even">
                                    ...
                                    <td class="text-center end-td " id="increment">
                                        <button type="button" class="btn btn-primary add_new"
                                            id="btn-{{ count($internalAudit->internalAudit) - 1 }}"
                                            onclick="appendRow({{ count($internalAudit->internalAudit) - 1 }})"><i
                ...
                @if (Auth::user()->hasRole('Employee'))
                    <div class="form-group row w-100 text-right">
                        ...
                        <div class="col-3">
                            <input type="text" class="form-control" value="{{ $internalAudit->reference_name }}"
                                name="reference_name" placeholder="إسم المراجع  ......" id="">
                        </div>
                        <label for="" class="col-1 col-form-label"> الوظيفة :</label>
                        <div class="col-3">
                            <input type="text" class="form-control" name="job" value="{{ $internalAudit->job }}"
                                placeholder="الوظيفة  ......" id="">
                        </div>
                    </div>
                @endif
                ...
                @if (($internalAudit->status == 'inProgress' && Auth::user()->hasRole('Employee')) ||
                    ...
                    <div class="form-group row w-100 text-right">
                        ...
                        <div class="col-3">
                            <input type="text" class="form-control" readonly name="quality_manager_name"
                                value="{{ $internalAudit->quality_manager_name }}"
                    ...
                    <th>
                        <div class="" style="text-align:start ;">
                            <input class="form-control" type="text" name="company_name"
                                value="{{ $internalAudit->company_name }}" placeholder="اسم الشركة  :">
                        </div>
                    ...
                    <th>
                        <div class="" style="text-align:start ;">
                            <input class="form-control" type="text" name="date2"
                                value="{{ $internalAudit->date2 }}" placeholder="تاريخ الإصدار   :"
