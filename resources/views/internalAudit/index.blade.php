...
<div class="card-body  ">
      <h3 style="margin-top:85px; text-shadow: 1px 1px 1px #3ed3ea;">قائمة المراجعات الداخلية لنظام الجودة</h3>
      <hr>
      <div class="row" >
       
          <a  href="{{ route('internalAudit.create') }}" class="btn btn-primary mr-1" style="width:120px;  float: right; font-size:20px ">
