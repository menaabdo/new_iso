...
<div class="card">
    <div class="card-body row" style='margin:auto;margin-top:80px'>
        ...
        <form action="{{ route('externalCases.store') }}" style='margin:auto;width:70%' method="post" enctype="multipart/form-data" id="fo1">
            ...
            <div class='row mt-3'>
            <button style="border-radius:8px;margin: 50px; width:30% ;background-color: #2a415b; ;height: 5%;padding:10px;margin-right:100px" type="submit" class="btn btn-primary col-md-4">
