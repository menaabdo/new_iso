...
@section('content')
    ...
    font-weight: bold;">@lang('main.Assigning an internal auditor')</h3>
                <hr>
            </div>
            <div class="row" style='margin:auto;width:90%'>

                <a href="{{ route('assigned.create') }}" class="btn col-md-12 mr-1"
                    style=" ">
    ...
    background-color:#001635;'
                ...
                <div style="overflow-x:auto;">
                                            ...
                                            <table id="example1" class="table  table-striped shadow-lg text-center">
                                                <thead>
