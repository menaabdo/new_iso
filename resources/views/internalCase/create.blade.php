            ...
            <div class="form-group row w-100 text-right" style="text-align:center;">
                <table class="table">
                    ...
                    <tr style="text-align:center;">
                        ...
                        <th><textarea class="form-control" type="text" name="political_effect"></textarea></th>
                        <th><textarea class="form-control" type="text" name="political_monitoring_review"></textarea></th>
                    </tr>
                    <tr style="text-align:center;">
                        <th>
                        ...
                        <th><textarea class="form-control" type="text" name="economic_effect"></textarea></th>
                        <th><textarea class="form-control" type="text" name="economic_monitoring_review"></textarea></th>
                    </tr>
                    <tr style="text-align:center;">
                        <th>
                            <label>(SOCIAL)</label>
                        ...
                        <th><textarea class="form-control" type="text" name="social_effect"></textarea></th>
                        <th><textarea class="form-control" type="text" name="social_monitoring_review"></textarea></th>
                    </tr>
                    <tr style="text-align:center;">
                        <th>
                        ...
                        <th><textarea class="form-control" type="text" name="technology_effect"></textarea></th>
                        <th><textarea class="form-control" type="text" name="technology_monitoring_review"></textarea></th>
                    </tr>
                    <tr style="text-align:center;">
                        <th>
                            <label>(LEGAL)</label>
                        ...
                        <th><textarea class="form-control" type="text" name="legal_effect"></textarea></th>
                        <th><textarea class="form-control" type="text" name="legal_monitoring_review"></textarea></th>
                    </tr>
                    <tr style="text-align:center;">
                        <th>
                        ...
                        <th><textarea class="form-control" type="text" name="environment_effect"></textarea></th>
                        <th><textarea class="form-control" type="text" name="environment_monitoring_review"></textarea></th>
                    </tr>
                </table>
            </div>
            <hr class="w-100">
