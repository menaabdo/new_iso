     ...
     <section class="content" style='margin:auto;'>
        <div class="card" style='margin:auto;'>
            <div class="card-body" style='margin:auto;'>
                ...
                <h3 style='margin:auto;margin-top:85px;text-shadow: 1px 1px 1px #3ed3ea;'>استمارة قضايا داخليه</h3>
                <hr>
                </div>
                <div class="row" style='margin:auto;width:90%'>


                    <a href="{{ route('internalCases.create') }}" class="btn col-md-12 mr-1"
    ...
    background-color: white;' id='me'> اضافة جديدة</button></a> <div class="col-12">
                    ...
                    btn-icon mr-2"
                                                                        ...
                                                                        @if ($internalCases->status == 'pending' && Auth::user()->hasRole('Employee'))
                                                                            <button type="button"
                                                                                ...
                                                                                onclick="confirmDelete('delete-form-{{ $internalCases->id }}')">
                ...
                btn-icon "
                    ...
                    btn-icon mr-2"
                                                                        ...
                                                                        {{-- <a href="{{ route('internalCases.print', $internalCases->id) }}"
                                         data-id="{{ $internalCases->id }}"
                                        class="btn btn-lg btn-icon">
                                        <i class="fa fa-print"></i>
                                    </a> --}}

                                                                        {{-- <a href="#" data-id="{{ $internalCases->id }}"
