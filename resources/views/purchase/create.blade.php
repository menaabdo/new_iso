...
<section class="content">
	...
	@component('components.widget', ['class' => 'box-primary'])
		<div class="row">
			...
			<div class="col-sm-2">
				<div class="form-group">
					<button tabindex="-1" type="button" class="btn btn-link m-2 btn-modal"data-href="{{action('ProductController@quickAdd')}}" 
	...
	@component('components.widget', ['class' => 'box-primary', 'title' => __('purchase.add_payment')])
		<div class="box-body payment_row">
			...
			<div class="row">
				<div class="col-sm-12">
					<button type="button" id="submit_purchase_form" class="btn btn-primary btn_save_file">@lang('messages.save')</button>
				</div>
			</div>
		</div>
	@endcomponent
