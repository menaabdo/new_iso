...
<section class="content" style='margin:auto;'>
        <div class="card">
          ...
          <h3 style='margin:auto;margin-top:85px;text-shadow: 1px 1px 1px #3ed3ea;'>متابعة شكوى عميل</h3>
          <hr>
          </div>
        <div class="row" style='margin:auto;width:90%'>
     
           
              <a  href="{{ route('customerComplaints.create') }}" class="btn col-md-12 mr-1" style="width:120px;  float: right; font-size:20px ">
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped" >
                    ...
                    <tbody class="datatable-body text-center">
                      @foreach ($all_customerComplaints as $customerComplaints)
                          <tr class="datatable-row datatable-row-even">
                              <td class="datatable-cell" style="font-size:15px "><span><img src="{{asset($customerComplaints->logo)}}" alt="Image" width="50px"></span></td>
                              <td style="font-size:15px">
                                  <form id="delete-form-{{ $customerComplaints->id }}" 
                                      action="{{ route('customerComplaints.destroy', $customerComplaints->id) }}" method="post">
                                      <a href="{{ route('customerComplaints.edit', $customerComplaints->id) }}" class="btn btn-lg  
                                      ...
                                      <button type="button" class="btn btn-lg  btn-icon" 
                                          ...
                                          onclick="confirmDelete('delete-form-{{ $customerComplaints->id }}')">
