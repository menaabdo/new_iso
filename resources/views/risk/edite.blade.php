...
label , .col-md-6{text-align:center !important;}
    </style>
 ...
 <div class="card">
  ...
  <hr>
    ...
    <div class="form-group row w-100 text-right" >
      <label for="inputPassword" class="col-2 col-form-label">@lang('main.Management') / @lang('main.department')</label>
      <div class="col-5">
    ...
    <section class="w-50  mt-5" style='margin:auto'>
      <div class="row d-flex justify-content-between">
        <div class="col-md-6 text-center">
            <h3 class="text-center">@lang('main.prepare')</h3>
        ...
        <div class="col-md-6 text-center">
          <h3 class="text-center">@lang('main.approval')</h3>
      ...
      <div class="row mt-3">
        <div class='col-md-6'>
        <label class="text-start col-md-12" style='text-align:right'> @lang('main.date')</label>
          <div class='row'>     
        ...
        @if ($risk->status == 'confirmed' && Auth::user()->hasRole('Employee') || $risk->status == 'confirmed' && Auth::user()->hasRole('Admin') )
        <div class="col-md-6">
          <label class="" style='text-align:right'>@lang('main.Director of the Department')</label>
        ...
        <div class="col-md-6" style='text-align:right'>
            <label class="text-start" style='text-align:right'>@lang('main.Director of the Department')</label>
      ...
      <div class="row">
          ...
          <div class="col-md-6" style='text-align:right'>
            <label class="text-end">@lang('main.Department')</label>
            <input type="text" class="form-control w-100" name="department2" placeholder="    ......" value="{{ $risk->department2 }}">
          </div>
          @if ($risk->status == 'confirmed' && Auth::user()->hasRole('Employee') || $risk->status == 'confirmed' && Auth::user()->hasRole('Admin') )
          <div class="col-md-6">
            <label class="text-end" style='text-align:right'>@lang('main.Department')</label>
    ...
    <section style="justify-content:space-evenly; margin-top: 10%;margin:auto" class="p-4 my-4 " >
      <table class="table table-bordered">
        <thead>
          <tr>
            <th>
              <div class="" style="text-align:start ;">
                <input type="text" class="form-control" name="issuance"   value="{{ $risk->issuance }}">
              </div>
            ...
            <th>
              <div class="" style="text-align:start ;">
                ...
                <input type="text" class="form-control" name="period"  value="{{ $risk->period }}">
              </div>
            ...
            <th>
              <div class="" style="text-align:start ;">
                ...
                <input type="number" name="code" class="form-control" value="{{ $risk->code }}">
              </div>
