                                        ...
                                        <tbody class="datatable-body text-center">
                                            ...
                                            <tr class="datatable-row datatable-row-even" style="left: 0px;">
                                                ...
                                                <td style="font-size:15px">
                                                    <form id="delete-form-{{ $all_iso_archive->id }}" action="{{ route('meetingAgendaArchives.destroy', $all_iso_archive->id) }}" method="post">

                                                        <a href="{{ route('meetingAgendaArchives.edit', $all_iso_archive->id) }}" class="btn btn-lg  
