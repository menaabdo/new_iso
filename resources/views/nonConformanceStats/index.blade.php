...
@section('content')
    ...
    font-weight: bold;">@lang('main.Nonconformance statistics')</h3>
                <hr>
            </div>
            <div class="row" style='margin:auto;width:90%'>

                <a href="{{ route('nonConformanceStats.create') }}" class="btn col-md-12 mr-1"
                    style=" ">
                                                    ...
                                                    <tbody class="datatable-body text-center ">
                                                      ...
                                                      <tr class="datatable-row datatable-row-even">
                                                          ...
                                                          <td style="font-size:15px">
                                                              ...
                                                              class="d-flex justify-content-center"  action="{{ route('nonConformanceStats.destroy', $nonConformanceStats->id) }}" method="post">
