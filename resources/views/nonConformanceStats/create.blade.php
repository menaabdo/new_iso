...
<div class="card">
        ...
        <form action="{{ route('nonConformanceStats.store') }}" method="post" class='col-md-12' style='' enctype="multipart/form-data" id="fo1">
            ...
            <div class='row mt-4 mb-3' >
                <label class="form-label col-md-2 text-right ">@lang('main.Company Logo')</label>
            ...
            <div class="form-group row  text-right" style="text-align:center;overflow-x:auto;margin:auto;width:85%">
                ...
                <table class="table">
                    <tr style="background-color:    #001635; color:white;text-align:center;">
                        ...
                        <th scope="col" rowspan="2">@lang('main.Total nonconformities')</th>
                    </tr>
                    <tr style="background-color:    #001635; color:white;text-align:center;">
                    ...
                    <tr>
                       ...
                       scope="col" colspan="2">@lang('main.Total')
                        </th>
            ...
            <div class="form-group row ">
                <label for="" class="col-3 col-form-label text-right">@lang('main.conclusion'):</label>
                <div class="col-6">
