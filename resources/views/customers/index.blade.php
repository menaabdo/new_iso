...
<section class="content" style='margin:auto;'>
        ...
        <h3  style='margin:auto;margin-top:85px;text-shadow: 1px 1px 1px #3ed3ea;'>العمـــــــــــلاء</h3>
          <hr>
          </div>
        <div class="row" style='margin:auto;width:90%'>
     
           
              <a  href="{{ route('customers.create') }}"  class="btn col-md-12 mr-1" style="width:120px;  float: right; font-size:20px ">
