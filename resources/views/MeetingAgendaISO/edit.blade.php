...
td{
   ...
   text-shadow: 1px 1px 1px #3ed3ea;font-weight: bold;">@lang('main.Management review1')
</h3>
  ...
  <h4 style="text-align:center;margin-bottom:40px;color:#2a415b">@lang('main.Standard work steps') </h4>
        ...
        <form action="{{ route('meetingAgendasop.update', $iso->id) }}" method="post" enctype="multipart/form-data" id="fo1">
            @method('PUT')
            {{ csrf_field() }}
